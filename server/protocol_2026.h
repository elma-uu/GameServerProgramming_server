...
constexpr int VISUAL_BOSS_BELIAL_HAND_L = 8;   // left hand (base sprite)
constexpr int VISUAL_BOSS_BELIAL_HAND_R = 9;   // right hand (flipped)
...
// Boss hand moves to (target_x, target_y) over move_ms milliseconds
...
// Boss hand switches animation state: 0=idle  1=attack
